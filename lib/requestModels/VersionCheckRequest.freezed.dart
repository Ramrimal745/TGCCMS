...
part of 'VersionCheckRequest.dart';
...
class _$VersionCheckRequestImpl implements _VersionCheckRequest {
  _$VersionCheckRequestImpl({@JsonKey(name: 'Version') required this.version});
  ...
  @override
  String toString() {
    return 'VersionCheckRequest(version: $version)';
  }
