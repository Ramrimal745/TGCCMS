...
abstract class $BasicResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool? status, String? remarks});
}
...
class _$BasicResponseImpl implements _BasicResponse {
  const _$BasicResponseImpl({this.status, this.remarks});
  ...
  @override
  String toString() {
    return 'BasicResponse(status: $status, remarks: $remarks)';
  }
...
abstract class _BasicResponse implements BasicResponse {
  const factory _BasicResponse({final bool? status, final String? remarks}) =
      _$BasicResponseImpl;
